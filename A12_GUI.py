...
fonte = ('Times',15)
campo_responsavel = tk.Label(master=frame_pr, text = 'Responsavel', font=fonte, width=12, height=2)
...
campo_endereco = tk.Label(master= frame_pr, text= 'Endereço', font=fonte, width=10, height=2)
entrada_endereco = tk.Entry(master=frame_pr, width=30, font = fonte)
campo_endereco.grid(row=2, column=0)
